...
#define MyAppName "Mind"
#define MyEngineName "MindEngine"
...
#define MyAppExeName "mind.exe"
#define MyAppBatName "mind.bat"
#define MyAppAssocName MyAppName + " File"
#define MyAppAssocExt ".myp"
#define MyAppAssocKey StringChange(MyAppAssocName, " ", "") + MyAppAssocExt
#define MyAppId "{{2FB8B36B-1BE1-4A97-9203-E89D50F0BE6E}}"
...
LicenseFile=schematic\resources\documents\mind_license.txt
InfoBeforeFile=schematic\resources\documents\mind_before.txt
InfoAfterFile=schematic\resources\documents\mind_after.txt
; Uncomment the following line to run in non administrative install mode (install for current user only.)
;PrivilegesRequired=lowest
OutputDir={#SourcePath}\dist
OutputBaseFilename={#MyAppName}-windows-setup-v{#MyAppVersion}
UninstallDisplayIcon={app}\{#MyEngineName}\schematic\resources\icons\mind_windows_icn.ico
SetupIconFile=schematic\resources\icons\mind_windows_icn.ico
WizardImageFile=schematic\resources\images\windows\mind_192dpi_328_628.bmp
Compression=lzma
...
Root: HKA; Subkey: "Software\Classes\{#MyAppAssocKey}\DefaultIcon"; ValueType: string; ValueName: ""; ValueData: "{app}\{#MyEngineName}\{#MyAppExeName},0"
Root: HKA; Subkey: "Software\Classes\{#MyAppAssocKey}\shell\open\command"; ValueType: string; ValueName: ""; ValueData: """{app}\{#MyEngineName}\{#MyAppExeName}"" ""%1"""
Root: HKA; Subkey: "Software\Classes\Applications\{#MyAppExeName}\SupportedTypes"; ValueType: string; ValueName: ".myp"; ValueData: ""


[Icons]
;Name: "{autodesktop}\{#MyAppName}"; Filename: "{app}\{#MyAppExeName}"; Tasks: desktopicon; IconFilename: "{app}\{#MyEngineName}\schematic\resources\icons\mind_windows_icn.ico"
;Name: "{autoprograms}\{#MyAppName}"; Filename: "{app}\{#MyAppExeName}"
;Name: "{autoprograms}\Uninstall {#MyAppName}"; Filename: "{uninstallexe}"; IconFilename: "{app}\{#MyEngineName}\schematic\resources\icons\mind_windows_icn.ico"
