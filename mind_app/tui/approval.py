...
class ApprovalOverlay:
    ...
    def __init__(self) -> None:
        ...
        self._previous_control: Any = None
    ...
    def bind(self, application: Application[Any]) -> None:
        """绑定拥有该浮层的应用。"""
        self._application = application

    async def show(self, approval: dict[str, Any]) -> ApprovalDecision:
        """显示审批卡并等待用户完成选择。"""
...
def _normalize_decisions(approval: dict[str, Any]) -> list[ApprovalDecision]:
    """提取审批卡支持的选择并保持服务端顺序。"""
