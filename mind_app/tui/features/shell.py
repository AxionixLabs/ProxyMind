    ...
    def __init__(
        ...
        *,
        ...
        self.stdout_thread = threading.Thread(
            ...
            daemon=True,
            name="mind-tui-shell-stdout"
        )
        self.stderr_thread = threading.Thread(
            target=self._read_stream,
            args=("stderr", process.stderr),
            daemon=True,
            name="mind-tui-shell-stderr"
        )
        self.wait_thread = threading.Thread(
            target=self._wait_process,
            daemon=True,
            name="mind-tui-shell-wait"
        )
...
async def run_shell_escape(
    ...
    result = await run_shell_command(parsed.command)
