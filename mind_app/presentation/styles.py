...
ERROR_STYLE                 = TextStyle(foreground="#FF7A7A")
...
ERROR_DOT_STYLE             = TextStyle(foreground="#FF6B6B")
TOOL_CALLING_DOT_STYLE      = TextStyle(foreground="#D8B77F", bold=True)
...
ACTION_TOOL_CALLING_STYLE   = TextStyle(foreground="#D8B77F", bold=True)
ACTION_TOOL_INVOKED_STYLE   = TextStyle(foreground="#7DD3FC", bold=True)
ACTION_TERMINAL_STYLE       = TextStyle(dim=True)
COMMAND_STYLE               = TextStyle(foreground="#C8D2DD")
COMMAND_HEAD_STYLE          = TextStyle(foreground="#8FB8FF", bold=True)
