...
def snapshot(**updates: JsonValue) -> dict[str, JsonValue]:
    ...
    return {
        ...
        "filtered": 0, "connection_error": None,
        "authorization": {"state": "unknown", "credentials": None, "verification": "unverified", "generation": None, "expires_at": None, "error": None}, **updates,
    }
...
@pytest.mark.parametrize("updates", [
    ...
    {"authorization": {"state": "unknown", "credentials": None, "verification": "unverified", "generation": None, "expires_at": None, "error": "raw server error with secret"}},
])
