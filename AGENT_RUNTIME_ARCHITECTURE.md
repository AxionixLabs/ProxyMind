...
| `mind_app/runtime/turns/stream.py` | `runtime/session_loop.py`、`application/turn_pipeline.py` | 输入/输出准备、终态结果和模型正文投影已拆到 `stream_setup.py`、`stream_outcome.py`、`stream_model.py`；继续拆回合级展示、清理和副作用执行 |
