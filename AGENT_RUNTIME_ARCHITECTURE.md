...
| `mind_app/runtime/turns/stream.py` | `runtime/session_loop.py`、`application/turn_pipeline.py` | 输入/输出准备和终态结果已拆到 `stream_setup.py`、`stream_outcome.py`；继续拆模型流、展示投影和副作用执行 |
