...
| `frontends` | `mind_app` | 5 | 7 | `frontends/cli/bootstrap.py`<br>`frontends/cli/dispatch.py`<br>`frontends/mcp/server.py`<br>`frontends/tui/features/conversation.py`<br>`frontends/tui/session/turn.py` |
