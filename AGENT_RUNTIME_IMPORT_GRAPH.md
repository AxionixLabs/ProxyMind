...
| `mind_app` | `agent` | 4 | 4 | `mind_app/cli/dispatch.py`<br>`mind_app/runtime/tools/client_call.py`<br>`mind_app/runtime/turns/stream.py`<br>`mind_app/tui/session/loop.py` |
