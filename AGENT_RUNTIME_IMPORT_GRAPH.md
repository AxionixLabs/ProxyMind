...
- 包含生产与构建边界：`agent`、`applications`、`build`、`engine`、`infrastructure`、`metadata`、`mind`、`mind_app`、`mind_core`、`mind_npm`、`observability`、`protocol`、`server`、`setup`。
...
| `engine` | `infrastructure` | 2 | 4 | `engine/manage.py`<br>`engine/upgrade.py` |
| `engine` | `metadata` | 1 | 1 | `engine/manage.py` |
| `engine` | `observability` | 2 | 2 | `engine/manage.py`<br>`engine/upgrade.py` |
| `engine` | `protocol` | 2 | 3 | `engine/manage.py`<br>`engine/upgrade.py` |
| `infrastructure` | `metadata` | 2 | 2 | `infrastructure/platform/encoding.py`<br>`infrastructure/platform/file_assist.py` |
...
| `mind_app` | `engine` | 6 | 10 | `mind_app/assets.py`<br>`mind_app/cli/bootstrap.py`<br>`mind_app/controller.py`<br>`mind_app/runtime/mcp/keepalive.py`<br>`mind_app/runtime/mcp/service_lifecycle.py`<br>`mind_app/runtime/mcp/service_runtime.py` |
| `mind_app` | `infrastructure` | 20 | 23 | `mind_app/attach.py`<br>`mind_app/cli/bootstrap.py`<br>`mind_app/cli/dispatch.py`<br>`mind_app/cli/doctor.py`<br>`mind_app/cli/entry.py`<br>`mind_app/cli/frontend.py`<br>`mind_app/cli/mcp_registry.py`<br>`mind_app/cli/session_archive.py`<br>`mind_app/controller.py`<br>`mind_app/mcp/group.py`<br>`mind_app/paths.py`<br>`mind_app/runtime/mcp/external.py`<br>`mind_app/runtime/mcp/service_lifecycle.py`<br>`mind_app/runtime/mcp/service_runtime.py`<br>`mind_app/subscription/forwarding.py`<br>`mind_app/tui/features/helix.py`<br>`mind_app/tui/features/listener.py`<br>`mind_app/tui/features/mailbox.py`<br>`mind_app/tui/session/barriers.py`<br>`mind_app/tui/session/dispatch.py` |
...
| `mind_core` | `infrastructure` | 1 | 2 | `mind_core/licensing.py` |
...
- `engine -> infrastructure`：`engine/manage.py`、`engine/upgrade.py`
- `engine -> metadata`：`engine/manage.py`
- `engine -> observability`：`engine/manage.py`、`engine/upgrade.py`
- `engine -> protocol`：`engine/manage.py`、`engine/upgrade.py`
