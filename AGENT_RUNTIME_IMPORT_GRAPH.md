...
| `frontends` | `agent` | 5 | 16 | `frontends/mcp/server.py`<br>`frontends/subscription/forwarding.py`<br>`frontends/subscription/loop.py`<br>`frontends/subscription/runtime.py`<br>`frontends/subscription/ws.py` |
| `frontends` | `infrastructure` | 3 | 10 | `frontends/mcp/server.py`<br>`frontends/subscription/forwarding.py`<br>`frontends/subscription/runtime.py` |
| `frontends` | `metadata` | 4 | 4 | `frontends/mcp/server.py`<br>`frontends/subscription/client.py`<br>`frontends/subscription/opening.py`<br>`frontends/subscription/runtime.py` |
| `frontends` | `mind_app` | 1 | 7 | `frontends/mcp/server.py` |
| `frontends` | `observability` | 8 | 8 | `frontends/mcp/server.py`<br>`frontends/subscription/external_access.py`<br>`frontends/subscription/forwarding.py`<br>`frontends/subscription/loop.py`<br>`frontends/subscription/opening.py`<br>`frontends/subscription/runtime.py`<br>`frontends/subscription/status.py`<br>`frontends/subscription/ws.py` |
| `frontends` | `protocol` | 4 | 5 | `frontends/mcp/server.py`<br>`frontends/subscription/client.py`<br>`frontends/subscription/runtime.py`<br>`frontends/subscription/ws.py` |
| `frontends` | `server` | 1 | 1 | `frontends/subscription/external_access.py` |
