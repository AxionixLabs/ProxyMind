...
- [ ] 继续将 `stream_turn` 的状态转移、模型流、工具效果和输出投影拆成独立调用点。
...
| 2026-08-28 | 阶段 1 | CLI 改从终态 Event 投影退出码；`stream_turn` 已拆出请求与输出会话准备边界；全量测试 `2822 passed, 13 skipped` | 模型流、状态、工具效果、输出投影、TUI 和长生命周期 Session 接管待完成 |
