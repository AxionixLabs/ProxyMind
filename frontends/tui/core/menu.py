...
TUI_MENU_STYLE = Style.from_dict({
    "tui-menu.title": "bold",
    "tui-menu.title.current": "ansiblue",
    "tui-menu.status": "dim",
    "tui-menu.status.current": "bold ansiblue",
    "tui-menu.surface": "",
    "tui-menu.help": "dim",
    "tui-menu.search": "",
    ...
    "tui-menu.tab": "dim",
    "tui-menu.tab-selected": "bold ansiblue",
    "tui-menu.index": "",
    "tui-menu.index.active": "bold ansiblue",
    "tui-menu.label": "",
    "tui-menu.label.active": "bold ansiblue",
    "tui-menu.detail": "dim",
    "tui-menu.body": "",
    ...
    "tui-menu.detail-selected": "bold ansiblue",
    ...
    "tui-menu.footer.right.current": "bold nodim ansiblue",
